...
function _sjs(){
    ...
    this.open = function(target, w, h){
      ...
      this.makeStage("default");
          ...
          _this.stages[_this.stage].update();
        },40);
     ...
     */
   this.Image = function(src,alt,width,height,radius,show) {
      if(alt == undefined){
        this.alt="add text";
      }else{
        this.alt=alt;
      ...
      var serializeAttrs = ['width', 'height', 'x', 'y', 'sx','sy', 'ax', 'ay', 'topSpeed', 'src', 'alt', 'type', 'facingLeft', 'left_img', 'right_img', 'friction', 'classType', 'noBounds'];
      ...
      this.node.addEventListener("touchstart",(function(obj){ return function(e){obj.isHeld = true;} })(this),{passive: true});
